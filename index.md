...
<section id="why" class="bg-light">
  <div class="container py-5 my-5">
    <h2 class="h1 fw-bold mb-3 text-center">Client Diversity Is Not Optional</h2>
    <div class="text-center">
    </div>
...
<section id="clients" class="">
  <div class="container py-5 my-5">
    ...
    <div class="row justify-content-center ooverflow-auto">
          ...
          <table class="table table-bordered">
            <thead class="table-light">
              <tr>
                ...
                <th scope="col" style="mmin-width: 2rem;">Github</th>
                <th scope="col" style="mmin-width: 2rem;">Docs</th>
                <th scope="col" style="mmin-width: 2rem;">Discord</th>
                <th scope="col" style="mmin-width: 2rem;">Support</th>
              </tr>
            </thead>
            <tbody>
